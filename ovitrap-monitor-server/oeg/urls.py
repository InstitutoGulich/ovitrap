...
urlpatterns = [
    ...
    path('api/sign_s3', views.sign_s3),
    path('api/load_pic', views.load_pic),
    path('api/unload_pic', views.unload_pic),
    path('api/process', views.process),
    path('api/api-auth/', include('rest_framework.urls')),
    path('api/login/', views.login_view, name='login'),
    path('api/register/', views.register_view, name='register'),
    path('api/logout/', views.logout_view, name='logout'),
    path('api/session/', views.session_view, name='session'),
    path('api/whoami/', views.whoami_view, name='whoami'),
    path('api/get_csrf_token/', views.get_csrf, name='get_csrf_token'),
    path('api/station_batch_delete/', StationBatchDelete.as_view(), name='station_batch_delete'),
    path('api/station_batch_post/', StationBatchPost.as_view(), name='station_batch_post'),
    path('api/record_batch_post/', RecordBatchPost.as_view(), name='record_batch_post'),
]
